...
let modalShow = function(modalClick){
    modalViews[modalClick].classList.add('active_modal')
}

let modalHide = function(modalClick){
    modalViews[modalClick].classList.remove('active_modal')
}
...
modalCloses.forEach((modalButton, i) => {
    modalButton.addEventListener('click', () => {
        modalHide(i);
    })
})
